...
class FeatureGen(ABC, StaticMixin):
  ...
  def next(self, f: Type["UnaryColumnFeature"], *args, **kwargs) -> "FeatureGen":
    from lib.features.ComposedFeature import ComposedFeature
    from lib.features.unary import IdFeature
  ...
  def consecutive_count_of(self, target_value: Any) -> "FeatureGen":
    from lib.features.unary import ConsecutiveCountFeature
  ...
  def log(self) -> "FeatureGen":
    from lib.features.unary import LogFeature
  ...
  def moving_average(self, period: int) -> "FeatureGen":
    from lib.features.unary import MovingAverage
  ...
  def moving_sum(self, period: int) -> "FeatureGen":
    from lib.features.unary import SumFeature
    return self.next(SumFeature, periods=period)

  def ema(self, period: int) -> "FeatureGen":
    from lib.features.unary import EMAFeature
  ...
  def wma(self, period: int) -> "FeatureGen":
    from lib.features.unary import WeightedMovingAverage
  ...
  def trima(self, period: int) -> "FeatureGen":
    from lib.features.unary import TRIMAFeature
  ...
  def t3(self, period) -> "FeatureGen":
    from lib.features.unary import T3Feature
  ...
  def apo(self) -> "FeatureGen":
    from lib.features.unary import APOFeature
  ...
  def moving_midpoint(self, period: int) -> "FeatureGen":
    from lib.features.unary import MidpointFeature
  ...
  def moving_std(self, period: int) -> "FeatureGen":
    from lib.features.unary import StddevFeature
  ...
  def pct_change(self, period: int) -> "FeatureGen":
    from lib.features.unary import PctChangeFeature
  ...
  def lag(self, period: int) -> "FeatureGen":
    from lib.features.unary import LagFeature
  ...
  def moving_max(self, period: int) -> "FeatureGen":
    from lib.features.unary import MaxFeature
  ...
  def moving_min(self, period: int) -> "FeatureGen":
    from lib.features.unary import MinFeature
    return self.next(MinFeature, periods=period)

  def is_positive(self):
    from lib.features.unary import IsPositiveFeature
    return self.next(IsPositiveFeature)

  def minute(self):
    from lib.features.unary.times import MinuteFeature
    return self.next(MinuteFeature)

  def hour(self):
    from lib.features.unary.times import HourFeature
    return self.next(HourFeature)

  def flip_bool(self):
    from lib.features.unary import FlipBoolFeature
  ...
  def bbands_upper(self, period: int) -> "FeatureGen":
    from lib.features.unary import BBandsUpperFeature
